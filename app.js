...
window.I18N = {
  zh: {
    ...
    d_gather_band: "敌集结 5:00（加速）", d_send_now: "发兵！", d_your_march: "你行军 {x}",
    d_short_gather: "集结剩 {x}", d_short_land: "落地倒计时 {x}", d_short_imm: "发车后立刻", d_short_fill: "先填行军",
    d_cue_gather: "他集结剩 {x} 时发兵", d_cue_land: "来袭落地倒计时 {x} 时发兵",
  ...
  en: {
    ...
    d_gather_band: "Enemy gather 5:00 (rush)", d_send_now: "SEND!", d_your_march: "march {x}",
    d_short_gather: "gather -{x}", d_short_land: "land in {x}", d_short_imm: "send now", d_short_fill: "fill march",
    d_cue_gather: "Send at their gather -{x}", d_cue_land: "Send at land-in {x}",
